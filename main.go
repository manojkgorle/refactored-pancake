...
func main() {
	...
	// // fmt.Println(proof3)
	data, _ := os.ReadFile("/home/ubuntu/blobstreamx/proofs/proof_raw_85def2a7-9e65-4192-afc3-3279ced532cd.json")
	...
	input, _ := hexutil.Decode("0x00000000001354d46138cf9addf5fb9d6c4a5409614ef477f5d803e68bfaa4d5eb82f01480e17f3a000000000013560e")
	output, _ := hexutil.Decode("0x3f0d6bf4a31b826fc41412d1d9de6beeaea88d4a41ff627b554cc0cfe4e6b4e2c774ddb15226098bf286065460da8ccd6d2eabcb56ea6597f9971d7875e179ea")
	// digest, _ := hexutil.Decode("0x16df4a97d228dbf5c20398fa31357d96724dcd1df399d9919b2902f6a42850f1")
	circuitDigestBigInt, _ := new(big.Int).SetString("10345404386591439249226135926464026835701883791563178030133199911738176721137", 10)
	...
	fmt.Println("input bytes", input[:l-8])
